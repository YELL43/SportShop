                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="carousel clearfix">
                                <br>
                                <h5>สินค้าแนะนำ <span class="badge bg-danger">New</span></h5>
                                        ...
                                        <form method="post" action="manage_cart.php">
                                            <div class="box">
                                                <div class="card">
                                                    ...
                                                    <div class="price">
                                                        <div>
                                                            <span class="now-price"><?php echo $product_price ?> บาท</span>
                                                        </div>

                                                        <input type="hidden" name="Item_Name" value="<?php echo $product_name ?>">
                                                        <input type="hidden" name="Price" value="<?php echo $product_price ?>">
                                                        <a href="dataadd_cart.php?p_id=<?php echo $product_id ?>"><i class="bi bi-cart4"></i> ซื้อสินค้า</a>
