...
if ($_SESSION["user_status"] != 'employer') {  //check session
                ...
                <section class="row">
                    <div class="col-12 col-lg-12">
                        <div class="row">
                            ...
                            FROM `tb_orderdetail`INNER JOIN tb_user ON tb_orderdetail.user_id=tb_user.user_id WHERE payment_status = 'ตรวจสอบแล้ว' GROUP BY order_no  ORDER BY `tb_orderdetail`.`orderde_id` ASC;";
                                        ...
                                        <div class="card-header  ">
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-end">
                                                    ...
                                                    <span class="badge bg-primary"><?php echo  $payment_status ?></span>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form method="POST">
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="table-responsive">
                                                                    ...
                                                                    INNER JOIN tb_user ON tb_orderdetail.user_id=tb_user.user_id WHERE payment_status = 'ตรวจสอบแล้ว' AND order_no = '$order_no'  ORDER BY `tb_orderdetail`.`orderde_id` ASC";
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <button type="submit" name="submit" class="btn btn-primary">จัดส่ง</button>
                                                </form>
                                            </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "SELECT payment_id FROM tb_payment WHERE order_no = '$order_no'";
        $query = $conn->query($sql);
        $getid = mysqli_fetch_array($query);
        $insertdev = "INSERT INTO tb_delivery (order_id,payment_id)VALUES('$order_no','$getid[0]')";
        $query = $conn->query($insertdev);
        $update = "UPDATE tb_orderdetail set payment_status = 'กำลังจัดส่ง' WHERE order_no = '$order_no'";
        $queryup = $conn->query($update);

        if ($queryup) {
            echo '<script>';
            echo "window.location='show_order.php?do=success';";
            echo '</script>';
        } else {
            echo '<script>';
            echo "window.location='show_order.php?do=error';";
            echo '</script>';
        }
    }
