                ...
                <section class="row">
                    <div class="col-12 col-lg-12">
                        <div class="row">
                            ...
                            FROM `tb_orderdetail`INNER JOIN tb_user ON tb_orderdetail.user_id=tb_user.user_id WHERE payment_status = 'ตรวจสอบแล้ว' GROUP BY order_no  ORDER BY `tb_orderdetail`.`orderde_id` desc;";
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-6">
                                                                                <div class="row">
                                                                                    <div class="col-12">
                                                                                        <?php if ($payment_img == "" || $payment_img == null) { ?>

                                                                                            <span class="badge rounded-pill bg-danger">ยังไม่มีการโอนมาเลย ณ จุดจุดนี้</span>

                                                                                        <?php } else { ?>

                                                                                            <img src="upload/payment/<?php echo  $payment_img ?>" width="300px" height="300px">
                                                                                        <?php } ?>
